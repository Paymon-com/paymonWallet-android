...
public class BlurLockView extends FrameLayout
    ...
    private String correctPassword = User.CLIENT_SECURITY_PASSWORD_VALUE;
    private int passwordLength = correctPassword != null ? correctPassword.length() : 8;
    ...
    private void init() {
        ...
        rightButton.setOnClickListener((view) -> {
            if (onRightButtonClickListener != null && User.CLIENT_SECURITY_PASSWORD_VALUE != null)
    ...
    public void setOnRightButtonClickListener(OnRightButtonClickListener onLeftButtonClickListener) {
        this.onRightButtonClickListener = onLeftButtonClickListener;
    }
    ...
    private void compareInput() {
        ...
        if (User.CLIENT_SECURITY_PASSWORD_VALUE == null && notConfirmedPassword == null) {
            ...
            User.CLIENT_SECURITY_PASSWORD_VALUE = confirmedPassword;
            User.CLIENT_SECURITY_PASSWORD_HINT = hint;
            User.saveConfig();

            onPasswordInputListener.correct(inputedString);
        }
    }
    ...
    public void onPress(String string) {
        ...
        if (User.CLIENT_SECURITY_PASSWORD_VALUE != null) {
            if (correctPassword.equals(inputedString)) {
                ...
                if (correctPassword.length() > inputedString.length()) {
                    // input right now
                    if (onPasswordInputListener != null)
                        onPasswordInputListener.input(inputedString);
                } else {
                    // incorrect password
                    if (onPasswordInputListener != null)
                        onPasswordInputListener.incorrect(inputedString);
