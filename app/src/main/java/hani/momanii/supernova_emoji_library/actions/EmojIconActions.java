...
import hani.momanii.supernova_emoji_library.helper.EmojiconContainer;
...
public class EmojIconActions implements View.OnFocusChangeListener {
    ...
    private int keyBoardIcon = R.drawable.ic_keyboard;
    private int smileyIcons = R.drawable.ic_smile;
    ...
    public void showEmojIcon() {
        ...
        popup.setOnEmojiconClickedListener(new EmojiconContainer.OnEmojiconClickedListener() {
    ...
    public void setOnStickerClickListener(EmojiconsPopup.StickersListener listener) {
        popup.setStickersListener(listener);
    }
}
