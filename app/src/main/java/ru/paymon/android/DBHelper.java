...
//                message.id, message.from_id, message.to_peer.channel_id, message.to_peer.user_id, message.to_peer.group_id, message.reply_to_msg_id, message.text, message.unread, message.itemType, message.itemID));
...
//                KEY_CHANNEL_ID + "='" + message.to_peer.channel_id + "', " +
//                KEY_USER_ID + "='" + message.to_peer.user_id + "', " +
//                KEY_GROUP_ID + "='" + message.to_peer.group_id + "', " +
