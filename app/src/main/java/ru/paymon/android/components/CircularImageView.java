...
public class CircularImageView extends AppCompatImageView {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (attributes.getBoolean(R.styleable.CircularImageView_civ_border, true)) {
            ...
            if (attributes.getColor(R.styleable.CircularImageView_civ_border_color, Color.WHITE) == getResources().getColor(R.color.borderGreen))
                setBorderShape(1);
            else if (attributes.getColor(R.styleable.CircularImageView_civ_border_color, Color.WHITE) == getResources().getColor(R.color.borderRed))
                setBorderShape(2);
            else if (attributes.getColor(R.styleable.CircularImageView_civ_border_color, Color.WHITE) == getResources().getColor(R.color.borderBlue))
                setBorderShape(3);
        }
    ...
    public void setBorderShape(int color) {
        switch (color) {
            case 1:
                paintBorder.setShader(new LinearGradient(0, 50, 50,0, getResources().getColor(R.color.borderGreenGradientFrom), getResources().getColor(R.color.borderGreenGradientTo), Shader.TileMode.CLAMP));
                break;
            case 2:
                paintBorder.setShader(new LinearGradient(0, 50, 50,0, getResources().getColor(R.color.borderRedGradientFrom), getResources().getColor(R.color.borderRedGradientTo), Shader.TileMode.CLAMP));
                break;
            case 3:
                paintBorder.setShader(new LinearGradient(50, 0, 0,50, getResources().getColor(R.color.borderBlueGradientFrom), getResources().getColor(R.color.borderBlueGradientTo), Shader.TileMode.CLAMP));
                break;
        }
    }
}
