...
public class SerializedBuffer implements SerializableData {
    ...
    private static final ThreadLocal<SerializedBuffer> addressWrapper = new ThreadLocal<SerializedBuffer>() {
        @Override
        protected SerializedBuffer initialValue() {
            return new SerializedBuffer(0, true);
        }
    };

    public static SerializedBuffer wrap(int address) {
        SerializedBuffer result = addressWrapper.get();
        if (address != 0) {
            if (!result.reused) {
//                Log.e(Config.TAG, "forgot to reuse?");
            }
    ...
    private SerializedBuffer(int address, boolean wrap) {

    }

    public SerializedBuffer(int size) throws Exception {
//        if (size >= 0) {
...
//        } else {
//            throw new Exception("invalid SerializedBuffer size");
//        }
    ...
    public SerializedBuffer(boolean calculate) {
        justCalc = calculate;
    }
    ...
    public void writeInt32(int x) {
        try {
            ...
            Log.e(Config.TAG, "write int32 error");
        }
    }
    ...
    public void writeInt64(long x) {
        try {
            ...
            Log.e(Config.TAG, "write int64 error");
        }
    }
    ...
    public void writeBytes(byte[] b) {
        try {
            ...
            Log.e(Config.TAG, "write raw error");
        }
    }
    ...
    public void writeByte(byte b) {
        try {
            ...
            Log.e(Config.TAG, "write byte error");
        }
    }
    ...
    public void writeString(String s) {
        try {
            if (s != null) {
                ...
                writeByteArray("".getBytes("UTF-8"));
            }
        } catch(Exception e) {
            Log.e(Config.TAG, "write string error");
        }
    }
    ...
    public void writeByteArray(byte[] b, int offset, int count) {
        try {
            ...
            Log.e(Config.TAG, "write byte array error");
        }
    }
    ...
    public void writeDouble(double d) {
        try {
            ...
            Log.e(Config.TAG, "write double error");
        }
    }

    public void writeByteBuffer(SerializedBuffer b) {
        try {
            int l = b.limit();
            if (l <= 253) {
                if (!justCalc) {
    ...
    public void writeBytes(SerializedBuffer b) {
        if (justCalc) {
            len += b.limit();
        } else {
            b.rewind();
    ...
    public int readInt32(boolean exception) {
        try {
            ...
            if (exception) {
                ...
                Log.e(Config.TAG, "read int32 error");
            }
        }
        return 0;
    }
    ...
    public boolean readBool(boolean exception) {
        ...
        if (exception) {
            ...
            Log.e(Config.TAG, "Not bool value!");
        }
        return false;
    }
    ...
    public long readInt64(boolean exception) {
        try {
            ...
            if (exception) {
                ...
                Log.e(Config.TAG, "read int64 error");
            }
        }
        return 0;
    }
    ...
    public void readBytes(byte[] b, boolean exception) {
        try {
            ...
            if (exception) {
                ...
                Log.e(Config.TAG, "read raw error");
            }
        }
    }
    ...
    public String readString(boolean exception) {
        try {
            ...
            if (exception) {
                ...
                Log.e(Config.TAG, "read string error");
            }
        }
        return null;
    }
    ...
    public byte[] readByteArray(boolean exception) {
        try {
            ...
            if (exception) {
                ...
                Log.e(Config.TAG, "read byte array error");
            }
        }
        return new byte[0];
    }

    public SerializedBuffer readByteBuffer(boolean exception) {
        try {
            int sl = 1;
            int l = getIntFromByte(buffer.get());
            if (l >= 254) {
            ...
            SerializedBuffer b = new SerializedBuffer(l);
    ...
    public double readDouble(boolean exception) {
        try {
            ...
            if (exception) {
                ...
                Log.e(Config.TAG, "read double error");
            }
        }
        return 0;
    }
