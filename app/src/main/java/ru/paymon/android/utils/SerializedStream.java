...
public class SerializedStream implements SerializableData {
    ...
    public SerializedStream() {
        outbuf = new ByteArrayOutputStream();
        out = new DataOutputStream(outbuf);
    }

    public SerializedStream(boolean calculate) {
        if (!calculate) {
            outbuf = new ByteArrayOutputStream();
            out = new DataOutputStream(outbuf);
        }
    ...
    public SerializedStream(int size) {
        outbuf = new ByteArrayOutputStream(size);
        out = new DataOutputStream(outbuf);
    }

    public SerializedStream(byte[] data) {
        isOut = false;
    ...
    public SerializedStream(File file) throws IOException {
    ...
    public void writeBytes(byte[] b, int offset, int count) {
        try {
            ...
            Log.e(Config.TAG, "write bytes error");
        }
    }
    ...
    public void readBytes(byte[] b, boolean exception) {
        try {
            ...
            if (exception) {
                ...
                Log.e(Config.TAG, "read bytes error");
            }
        }
    }
    ...
    public void writeByteBuffer(SerializedBuffer buffer) {
