...
public class User {
    ...
    public static final String CLIENT_MONEY_FIRST_TIME_KEY = "CLIENT_MONEY_FIRST_TIME_KEY";
    ...
    public static boolean CLIENT_MONEY_FIRST_TIME;
    ...
    public static void loadConfig() {
        ...
        CLIENT_MONEY_FIRST_TIME = clientPreferences.getBoolean(CLIENT_MONEY_FIRST_TIME_KEY, true);
    ...
    public static void saveConfig() {
        ...
        editor.putBoolean(CLIENT_MONEY_FIRST_TIME_KEY, CLIENT_MONEY_FIRST_TIME);
